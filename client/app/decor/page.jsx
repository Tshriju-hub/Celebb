    ...
    <div className="min-h-screen bg-gradient-to-br from-[#7a1313] to-[#4a0c0c]">
      <main className="p-8">
        ...
        <div className="relative mb-12">
          <h1 className="text-4xl font-bold text-white text-center mb-4">Decoration Services Gallery</h1>
        ...
        {images.length === 0 ? (
          <div className="text-center py-16 bg-white/10 backdrop-blur-sm rounded-2xl shadow-lg">
            ...
            <p className="text-white/70 text-lg">No decoration service images available yet.</p>
          </div>
        ) : (
